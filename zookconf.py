...
class Container():
    ...
    def make_base(self):
        ...
        if not self.c.create("local", 0,
                        { "fstree":   "/usr/local/6566/lxcbase/rootfs.tar.xz",
                          "metadata": "/usr/local/6566/lxcbase/meta.tar.xz" }):
    ...
    def configure_base(self):
        self.c.set_config_item('lxc.log.level', 'DEBUG')
        self.c.set_config_item('lxc.log.file', '/tmp/lxc.log')
        ...
        self.dup_dir("/usr/local/share/Python-3.11.0-wasm32-wasi-16", "/")
    ...
    def make_container(self):
        ...
        self.c = c
        self.c.append_config_item('lxc.mount.entry', '/home/student/lab app none bind,ro,create=dir 0 0')
        self.c.append_config_item('lxc.mount.entry', 'tmpfs app/zoobar/db tmpfs create=dir 0 0')
        self.c.save_config()
    ...
    def dup_dir(self, host_dir, guest_prefix, excludes=[]):
        exclude_args = []
        for e in excludes:
